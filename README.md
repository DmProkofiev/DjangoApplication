...
#### View
Класс, который решает, что увидит пользователь, когда перейдёт по определённому адресу на вашем сайте. Обрабатывает запрос, выполняет логику и возвращает ответ.
